...
namespace milestone
{
    ...
    class Tree:Form1
    {
        ...
        {
            StreamWriter streamWriter = new StreamWriter(@"C:\Users\fahad\Desktop\milestone\milestone\milestone\schemeFile.txt");
        ...
        {
            StreamWriter sw = new StreamWriter(@"C:\Users\fahad\Desktop\milestone\milestone\milestone\compress.txt");
        ...
        {
            string file = @"C:\Users\fahad\Desktop\milestone\milestone\milestone\compress.txt";
